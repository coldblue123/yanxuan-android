...
public class Quanju extends Application {
	...
	public void Init() {
		...
		if (GoodsList.size()<=0) {
			...
			String[] classifyList = { "舌尖上的特产", "来自星星零食", "来自热剧的零食",
					"来自穿越的零食", "舌尖上的特产", "来自星星零食", "来自热剧的零食",
					"来自穿越的零食",  "舌尖上的特产", "来自星星零食" };
			
			String[] introList = { "酸辣粉起源于四川,是四川省、重庆市、贵州省等地的传统特色小吃,属于渝菜、川菜、贵州小吃。其特点是麻、辣、鲜、香、酸且油而不腻。", 
			...
			String[] imageList = { "malafen1,malafen2,malafen3,malafen4,malafen5", 
					"fenlisu1,fenlisu2,fenlisu3,fenlisu4,fenlisu5",
					"guzi1,guzi2,guzi3,guzi4,guzi5",
					"guiyuan1,guiyuan2,guiyuan3,guiyuan4,guiyuan5", 
					"jxmashu1,jxmashu2,jxmashu3,jxmashu4,jxmashu5", 
					"narou1,narou2,narou3,narou4,narou5",
					"lzhluoshifen1,lzhluoshifen2,lzhluoshifen3,lzhluoshifen4,lzhluoshifen5", 
					"yezi1,yezi2,yezi3,yezi4,yezi5,yezi6,yezi7,yezi8", 
					"yunlanxuanhuabing1,yunlanxuanhuabing2,yunlanxuanhuabing3,yunlanxuanhuabing4,yunlanxuanhuabing5,yunlanxuanhuabing6", 
					"xiehuangsu1,xiehuangsu2,xiehuangsu3,xiehuangsu4,xiehuangsu5" };
			/*
